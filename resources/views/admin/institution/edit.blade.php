                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <form method="post" action="{{ action('Admin\InstitutionController@update', $id) }}" class="row">
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="row addresses">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input list="city" name="city" class="form-control" value="{{$address->city}}"
                                        id="city">
                                </div>
                                <div class="form-group col-lg-6">
                                    ...
                                    <select id="country" class="addr form-control" name="country">
                                        ...
                                        <option class="text-capitalize" value="{{$val}}" selected>
                                            {{$item['country_name']}}</option>
                                        @else
                                        <option class="text-capitalize" value="{{$val}}">{{$item['country_name']}}
                                        </option>
                                        @endif
                                        @endforeach
                                        @endif
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <a href="{{ action('Admin\InstitutionController@index') }}" class="btn btn-secondary">
                                Cancel</a>
                        </div>
                    </form>
                </div>
