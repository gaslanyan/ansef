            ...
            <div class="card">
                ...
                <div class="card-body ajaxdiv" style="overflow:auto;">
                    ...
                    <div class="col-12" style="margin-bottom:20px;padding-bottom:35px;">
                        <button type="button" title="delete" onclick="deletereports();"
...
<script>
                ...
                "columns": [{
                    ...
                    },
                    {
                        "render": function (data, type, full, meta) {
                            var ID = full.id;
                            return '<button class="btn btn-link" onclick="open_container(' +
                                ID + ')">' +
    ...
    function format(d) {
        var table =
            '<table style="width:100%;"><thead><tr><th width="" style="text-align:left;color:#999;">Score category</th><th width="" style="text-align:center;color:#999;">Score</th></thead>';
        table += '<tbody>';
        if (d.scores.length) {
            ...
            for (var i in s) {
                if (s.hasOwnProperty(i)) {
                    table += '<tr>';
                    table += '<td style="text-align:left;color:#048;"><b>' + s[i].name +
                        '</b></td><td style="text-align:center">' + s[i].value + '</td>';
                    table += '</tr>';
                }
            }
            table +=
                '<tr><td colspan="2" style="text-align:left;white-space:pre-wrap;padding:20px;"><b>Public comments</b><br/>' +
                d.public + '</td></tr>';
            table +=
                '<tr><td colspan="2" style="text-align:left;white-space:pre-wrap;padding:20px;"><b>Private comments</b><br/>' +
                d.private + '</td></tr>';
            flag = false;
        }
