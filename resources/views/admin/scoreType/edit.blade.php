        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <form method="post" class="row" action="{{action('Admin\ScoreTypeController@update',
                              $scoreType->id) }}">
                        @csrf
                        <div class="form-group col-lg-6">
                            <input name="_method" type="hidden" value="PATCH">
                            <label for="name">Score Type Name *:</label>
                            <input type="text" class="form-control" name="name" id="name" value="{{$scoreType->name }}">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="number" class="form-control" id="min" name="min" value="{{$scoreType->min}}">
                        </div>
                        <div class="form-group col-lg-4">
                            <label for="max">Score Type Max value:</label>
                            <input type="number" class="form-control" id="max" name="max" value="{{$scoreType->max}}">
                        </div>
                        <div class="form-group col-lg-4">
