...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Add a score type
                </div>
                <div class="card-body" style="overflow:auto;">
                    ...
                    <form method="post" action="{{ action('Admin\ScoreTypeController@store') }}" class="row">
                        @csrf
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control cat" name="competition_id" id="competition">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <textarea class="col-lg-12" id="description"
                                name="description">{{old('description')}}</textarea>
                        </div>
                        <div class="form-group col-lg-4">
                            <label for="min">Score Type Min value *:</label>
                            <input type="number" class="form-control" id="min" name="min" value="{{old('min')}}">
                        </div>
                        <div class="form-group col-lg-4">
                            <label for="max">Score Type Max value *:</label>
                            <input type="number" class="form-control" id="max" name="max" value="{{old('max')}}">
                        </div>
                        <div class="form-group col-lg-4">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <a href="{{ action('Admin\ScoreTypeController@index') }}"
...
<script>
    ...
    jQuery('#choose').on('click', function () {
        ...
        if (checkedIDs.length > 0) {
            ...
            alert('Please Choose Score Type!')
    });
