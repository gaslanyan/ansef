                 ...
                 <div class="card" >
                    ...
                    <div class="card-body card_body">
                        ...
                        @if($competitions->isNotEmpty())
                                ...
                                <form method="post" action="{{ action('Admin\RankingRuleController@executeQuery') }}" >
                                    <div class="row">
                                    @csrf
                                    <div class="form-group col-lg-12">
                                        <label for="rule_com">Competition Name:</label>
                                        <select class="form-control" name="competition_id"
                                                id="rule_com">
                                            <option value="0">Select Competition</option>
                                            <?php if(!empty($competitions)):?>
                                            <?php foreach($competitions as $key=>$item):?>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <label for="budget">SQL rules:</label>
                                        <select class="form-control" name="rules[]" multiple
                                                id="rule">
                                            <option value="0">Select one or more rules</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-lg-12">
