            ...
            <div class="card">
                ...
                <div class="card-header">
                    <a href="{{action('Admin\RankingRuleController@create')}}"
                        ...
                        ranking rule</a>
                    <button type="button" title="change state" onclick="executerules()"
                        class="display float-lg-left btn-primary px-2 myButton">
                        <i class="fas fa-cogs"></i>
                        Execute rules
                    </button>
                    <input style="margin-left:20px;margin-top:12px;" type="checkbox" name="cleanup" value="0"
                        id="cleanup"> Cleanup before execution
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4" style="margin:0;padding:0;">
                            <div class="row" style="margin:0;padding:0;">
                                ...
                                <a class=" myButton" onclick="showstats({{$cid}},'participants')">Show participants
                                    stats</a>
    ...
    function showstats(cid, t) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#stats').html("<br/><b>Statistics for " + $('#competition option:selected').text() +
                    "</b>" + data.content);
            },
            error: function (data) {
                $('#stats').html("Error");
