                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <form method="post" class="row"
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control" name="name" value="{{$budget->name}}" id="name">
                        </div>
                        <div class="form-group col-lg-6">
                            ...
                            <select id="text" class="form-control" name="competition_id" id="competition">
                                ...
                                <option class="text-capitalize" <?php if ($key == $budget->competition_id):
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="number" class="form-control" id="min" name="min" value="{{$budget->min}}">
                        </div>
                        <div class="form-group col-lg-4">
                            <label for="max">Budget Max value * :</label>
                            <input type="number" class="form-control" id="max" name="max" value="{{$budget->max}}">
                        </div>
                        <div class="form-group col-lg-4">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <a href="{{ action('Admin\BudgetCategoryController@index') }}"
