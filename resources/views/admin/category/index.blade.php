                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <div class="btn_add col-md-12">
                        ...
                        <button type="button" disabled title="delete" id="deleteCats"
                            class="btn-link btn delete_cats col-lg-2 col-md-3"><i class="fa fa-trash-alt"></i>
                            Delete
                        </button>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-order="{{$category['abbreviation']}}"
                                    data-search="{{$category['abbreviation']}}" class="abbreviation_field">
                                ...
                                <td class="state_field" data-order="{{ $gsv}}" data-search="{{$gsv}}">
                                    ...
                                    <select class="form-control" name="parent_id" disabled>
                                        ...
                                        <option class="text-capitalize" value="{{$item->id}}" @if($item->id ===
                                            $category['parent_id'])
