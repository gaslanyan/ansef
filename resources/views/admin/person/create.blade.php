                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <form method="post" action="{{action('Admin\PersonController@update', $id)}}" class="row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input value="{{$person->first_name}}" type="text" class="form-control" name="first_name"
                                id="f_name">
                        </div>
                        <div class="form-group col-lg-6">
                            <label for="last_name">Last Name *:</label>
                            <input value="{{$person->last_name}}" type="text" class="form-control" name="last_name"
                                id="l_name">
                        </div>
                        <div class="form-group col-lg-6">
                            <label for="birthdate">Birth date:</label>
                            <input value="{{$person->birthdate}}" type="text" class="form-control date datepicker"
                                name="birthdate" id="birthdate">
                        </div>
                        <div class="form-group col-lg-6">
                            <label for="birthplace">Birth Place:</label>
                            <input value="{{$person->birthplace}}" type="text" class="form-control" name="birthplace"
                                id="birthplace">
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" name="nationality" id="nationality">
                                ...
                                <option class="text-capitalize" value="{{$item->id}}"
                                    {{$person->nationality == $item->id ? 'selected' : ''}}>{{$item->country_name}}
                                </option>
                                @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select id="type" class="form-control" name="sex">
                                ...
                                <option class="text-capitalize" value="{{$item}}"
                                    {{$person->sex == $item ? 'selected' : ''}}>{{$item}}</option>
                                @endforeach
                                @endif
                            </select>
                        </div>
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="row addresses">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input value="{{$address->street}}" type="text" class="form-control" name="street"
                                        id="street">
                                </div>
                                <div class="form-group col-lg-6">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input value="{{$address->province}}" type="text" class="form-control"
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select id="country" class="addr form-control" name="country">
                                        ...
                                        <option class="text-capitalize" value="{{$country->id}}"
