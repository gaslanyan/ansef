...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="offset-2 col-md-10">
            <div class="card">
                <div class="card-header">Edit Competition <a href="{{ action('Admin\CompetitionController@index') }}"
                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <form method="post" action="{{ action('Admin\CompetitionController@update', $com->id) }}"
                        class="row">
                        @csrf
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select id="type" class="form-control" name="state">
                                ...
                                <option class="text-capitalize"
                                    <?php if ($com->state == $item): echo "selected"; endif?> value="{{$item}}">
                                    {{$item}}</option>
                                <?php endforeach;?>
                                <?php endif;?>
                            </select>
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="text" class="form-control date datepicker" name="submission_end_date"
                                id="submission_end_date" value="{{$com->submission_end_date}}">
                        </div>
                        <div class="form-group col-lg-3">
                            ...
                            <input type="text" class="form-control date datepicker" name="announcement_date"
                                id="announcement_date" value="{{$com->announcement_date}}">
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="project_start_date">Project Start Date *:</label>
                            <input type="text" class="form-control date datepicker" value="{{$com->project_start_date}}"
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input type="number" class="form-control" name="min_budget" value="{{$com->min_budget}}"
                                id="min_budget">
                        </div>
                        <div class="form-group col-lg-2">
                            <label for="max_budget">Max Budget *</label>
                            <input type="number" class="form-control" name="max_budget" value="{{$com->max_budget}}"
                                id="max_budget">
                        </div>
                        <div class="form-group col-lg-2">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" name="min_level_deg_id" id="min_level_deg_id">
                                ...
                                <option class="text-capitalize"
                                    <?php if ($item->id == $com->min_degree['id']) echo 'selected'?>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" name="max_level_deg_id" id="max_level_deg_id">
                                ...
                                @foreach($degrees as $item)
                                <option class="text-capitalize"
                                    <?php  if ($item->id == $com->max_degree['id']) echo "selected" ?>
                                    value="{{$item->id}}">{{$item->text}}</option>
                                @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group col-lg-5">
                            ...
                            <input type="text" class="form-control date datepicker" value="{{$com->first_report}}"
                                name="first_report" id="first_report">
                        </div>
                        <div class="form-group col-lg-5">
                            <label for="second_report">Second Report Date *:</label>
                            <input type="text" class="form-control date datepicker" value="{{$com->second_report}}"
