                    ...
                    <div class="box-primary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <strong><i class="fa fa-calendar margin-r-5"></i>Submission start
                                        date:</strong>
                                    <p>@if(!empty($com['submission_start_date'])){{$com['submission_start_date']}}@endif
                                    </p>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="box-body col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <strong class="col-md-12"><i class="fa fa-list-ol margin-r-5"></i>Allowed
                                            categories:</strong><br /><br />
                                        <?php if (!empty($cats)): ?>
                                        <ol class="col-md-6">
                        ...
                        <div class="box-body col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span>@if($com['min_budget'] == 0) {{'None'}} @else {{'$'.$com['min_budget']}}
                                        @endif</span>
                                </div>
                                <div class="col-md-4">
                                    <strong><i class="fa fa-money margin-r-4"></i>Max budget limit:</strong>
                                    <span>@if($com['max_budget'] == 0) {{'None'}} @else {{'$'.$com['max_budget']}}
                                        @endif</span>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <strong><i class="fa fa-birthday-cake margin-r-4"></i>Min
                                        age limit:</strong>
                                    <span>@if($com['min_age'] == 0){{'None'}} @else {{$com['min_age'].' years'}}
                                        @endif</span>
                                </div>
                                <div class="col-md-4">
                                    <strong><i class="fa fa-birthday-cake margin-r-4"></i>Max
                                        age limit:</strong>
                                    <span>@if($com['max_age'] == 100){{'None'}} @else {{$com['max_age'].' years'}}
                                        @endif</spanp>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <strong><i class="fa fa-graduation-cap margin-r-5"></i> Min
                                        Degree:</strong>
                                    <span>@if($com['min_degree']['text'] == 'No degree'){{'Any'}} @else
                                        {{$com['min_degree']['text']}} @endif</span>
                                </div>
                                <div class="col-md-6">
                                    <strong><i class="fa fa-graduation-cap margin-r-5"></i> Max
                                        Degree:</strong>
                                    <span>@if($com['max_degree']['text'] == 'No degree'){{'Any'}} @else
                                        {{$com['max_degree']['text']}} @endif</span>
                                </div>
                            </div>
                            <hr>
                            <!-- /.box-body -->
                        ...
                        <div class="box-body col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p>@if($com->recommendations == 0){{'None'}}@else {{$com->recommendations}}@endif
                                    </p>
                                </div>
                            </div>
                            <hr>
                        ...
                        <div class="box-body col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <strong><i
                                            class="fa fa-calendar margin-r-5"></i>{{str_replace_first('_', " ",str_replace_first("_", " ", $index))}}
                                        :</strong>
                        ...
                        <div class="box-body col-md-12">
                            <div class="row">
                                ...
                                {{--                                                    value:</strong>--}}
                                {{--                                                <p>@if(!empty($value->max)){{$value->max}}
                                @endif</p>--}}
                                {{--                                            </div>--}}
