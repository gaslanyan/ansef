                    ...
                    <form method="post" action="{{ action('Admin\CompetitionController@store') }}" class="row">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <select multiple class="form-control cat" name="category[]" id="category">
                                ...
                                <option class="text-capitalize" @if(isset($old_category) && in_array($item->
                                    id,$old_category)) {{'selected'}} @endif
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <textarea rows="4" class="form-control" name="description"
                                id="description">@if(isset($old)){{$old}} @endif</textarea>
                        </div>
                        <div class="form-group col-lg-6">
                            @php
                            $old = old('comments');
                            ...
                            <textarea rows="4" class="form-control" name="comments"
                                id="comments">@if(isset($old)){{$old}} @endif</textarea>
                        </div>
                        <div class="form-group col-lg-12">
                            @php
                            ...
                            <textarea rows="4" class="form-control" name="instructions"
                                id="instructions">@if(isset($old)){{$old}} @endif</textarea>
                        </div>
                        <div class="form-group col-lg-2">
                            <label for="announcement_date">Announcement *:</label>
                            <input type="text" class="form-control date datepicker" name="announcement_date"
                                id="announcement_date" value="{{old('announcement_date')}}">
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="submission_start_date">Submission Start *:</label>
                            <input type="text" class="form-control date datepicker" name="submission_start_date"
                                id="submission_start_date" value="{{old('submission_start_date')}}">
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="submission_end_date">Submission End *:</label>
                            <input type="text" class="form-control date datepicker" name="submission_end_date"
                                id="submission_end_date" value="{{old('submission_end_date')}}">
                        </div>
                        <div class="form-group col-lg-2">
                            <label for="submission_end_date">Results *:</label>
                            <input type="text" class="form-control date datepicker" name="results_date"
                                id="results_date" value="{{old('results_date')}}">
                        </div>
                        <div class="form-group col-lg-2">
                            <label for="project_start_date">Project Start *:</label>
                            <input type="text" class="form-control date datepicker" name="project_start_date"
                                id="project_start_date" value="{{old('project_start_date')}}">
                        </div>
                        <div class="form-group col-lg-2">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input type="number" class="form-control" name="min_budget" id="min_budget"
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input type="number" class="form-control" name="max_age" id="max_age"
                                value="{{old('max_age')}}">
                        </div>
                        <div class="form-group col-lg-2">
                            <label for="allow_foreign" class="label">Allow Foreign PI?
                                <input type="checkbox" class="form-control" name="allow_foreign" id="allow_foreign"
                                    value="{{old('allow_foreign')}}">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" name="min_level_deg_id" id="min_level_deg_id">
                                ...
                                <option class="text-capitalize" @if(old('min_level_deg_id')==$item->id){{'selected'}}
                                    @endif
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" name="max_level_deg_id" id="max_level_deg_id">
                                ...
                                @if(!empty($degrees))
                                @foreach($degrees as $item)
                                <option class="text-capitalize" @if(old('max_level_deg_id')==$item->id){{'selected'}}
                                    @endif
                                    value="{{$item->id}}">{{$item->text}}</option>
                                @endforeach
                                @endif
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control date datepicker" name="first_report"
                                id="first_report" value="{{old('first_report')}}">
                        </div>
                        <div class="form-group col-lg-4">
                            <label for="second_report">Second Report Date *:</label>
                            <input type="text" class="form-control date datepicker" name="second_report"
                                id="second_report" value="{{old('second_report')}}">
                        </div>
                        <div class="form-group col-lg-4">
                            <label for="recommendations" class="label">Min. recommendations:</label>
                            <input type="number" class="form-control" name="recommendations" id="recommendations"
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="number" class="form-control" name="additional_charge" id="additional_charge"
                                value="{{(isset($old))? $old: 0}}" min="0">
                        </div>
                        <div class="form-group col-lg-3">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <a href="{{ action('Admin\CompetitionController@index') }}"
