                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <table class="table table-responsive-md table-sm table-bordered display compact" id="example"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-order="@if(!empty($com->title)){{$com->title}} @endif"
                                    data-search="@if(!empty($com->title)){{$com->title}}@endif" class="title_field">
                        ...
                        date datepicker" name="submission_start_date"
                                ...
                                <td data-order="@if(!empty($com->results_date)){{$com->results_date}}@endif"
                                    ...
                                    <input type="text" class="form-control
                                        ...
                                        value="@if(!empty($com->results_date)){{$com->results_date}}@endif" disabled>
                                </td>
                        ...
                        date datepicker" name="first_report"
                                        value="@if(!empty($com->first_report)){{$com->first_report}}@endif" disabled>
                                </td>
                        ...
                        date datepicker" name="second_report"
                                        value="@if(!empty($com->second_report)){{$com->second_report}}@endif" disabled>
                                </td>

                                <td data-order="@if(!empty($com->state)){{$com->state}}@endif"
                                    data-search="@if(!empty($com->state)){{$com->state}}@endif" class="state_field">
                                    <select class="form-control" name="state" disabled>
                                        <?php $enum = getEnumValues('competitions', 'state');?>
                                        <option value="0">Select state</option>
                                        @if(!empty($enum))
                                        @foreach($enum as $item)
                                        <option class="text-capitalize" value="{{$item}}" @if($item===$com->state)
                                            {{'selected'}} @endif>{{$item}}
                                        </option>
                                        @endforeach
                                        @endif
                                ...
                                <td>
                                    ...
                                    <button title="Save" class="save editable btn-link"><i class="fa fa-save"></i>
                                    </button>
                                    <button title="Cancel" class="cancel editable btn-link"><i class="fa fa-ban"></i>
                                    </button>
                                    <a href="{{action('Admin\CompetitionController@show', $com->id)}}" class="view"
                                    ...
                                    <form action="{{action('Admin\CompetitionController@destroy', $com->id)}}"
                                        ...
                                        <button class="btn-link delete" type="button" data-title="competition">
