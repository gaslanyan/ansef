...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Show Publications for
                                ...
                                <div class="row col-12" style="margin-bottom: 5px;">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="journal[]"
                                            value="{{$publication['journal']}}" id="year">
                                    </div>
                                </div>
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="text" class="form-control" name="year[]"
                                            value="{{$publication['year']}}" id="year">
                                    </div>

                                    <div class="form-group col-lg-3">
                                        <label for="pub_edit_ansefsupported_<?= $i;?>" class="label">Supported by
                                            ANSEF?<br />
                                            <input type="checkbox" class="form-control form-check-inline"
                                                name="ansef_edit[{{$i}}]" id="pub_edit_ansefsupported_<?= $i;?>"
                                                <?= ($publication['ansef_supported'] == 1) ? 'checked' : '';?>>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>

                                    <div class="form-group col-lg-4">
                                        <label for="pub_edit_domestic<?= $i;?>" class="label">Is journal based in
                                            Armenia?<br />
                                            <input type="checkbox" class="form-control form-check-inline"
                                                name="domestic[{{$i}}]" id="pub_edit_domestic<?= $i;?>"
