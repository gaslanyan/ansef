                        ...
                        <div class="col-lg-12 ">
                            <div class="row institution">
                                <div class="form-group col-lg-4">
                                    ...
                                    <select id="inst" class="form-control" name="institution_id">
                                        ...
                                        <option class="text-capitalize" value="{{$item['id']}}"
                                            <?php echo (old('institution_id') == $item['id'] ? 'selected' : '');?>>
                                            {{$item['content']}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <input type="text" class="form-control" value="{{old('i_title')}}" name="i_title"
                                        id="title">
                                </div>
                                <div class="form-group col-lg-2">
                                    ...
                                    <select id="i_type" class="form-control" name="i_type">
                                        ...
                                        <option value="affiliation"
                                            {{old('i_type') == 'affiliation' ? 'selected' : ''}}>Affiliation</option>
                                        <option value="employment" {{old('i_type') == 'employment' ? 'selected' : ''}}>
                                            Employment</option>
                                    </select>
                                </div>
                                <div class="form-group col-lg-2">
                                    <label for="start">Start:</label>
                                    <input type="date" class="form-control date datepicker" value="{{old('start')}}"
                                        name="start" id="start">
                                </div>
                                <div class="form-group col-lg-2">
                                    <label for="end">End:</label>
                                    <input type="date" class="form-control date datepicker" value="{{old('end')}}"
                                        name="end" id="end">
                                </div>

                            </div>
                        </div>
                        <input type="hidden" class="form-control" name="institution_create_hidden" value="{{$id}}"
                            id="institution_create_hidden">
                            ...
                            <div class="row institution">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <select id="institution_id" class="form-control" name="institution_id[]">
                                        ...
                                        @foreach($institutions_list as $val => $item)
                                        <option class="text-capitalize" value="{{$item['id']}}"
                                            <?php if ($item['id'] == $ins->institution_id) { echo 'selected'; }?>>
                                            {{$item['content']}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                ...
                                <input type="hidden" class="form-check-inline" name="inst_hidden_id[]"
                                    value="{{$ins->id}}" id="inst_hidden_id">
                                @endforeach
                            </div>
                        </div>

                        <input type="hidden" class="form-control" name="institution_creare_hidden" value="{{$id}}"
                            id="institution">
                        <div class="form-group col-lg-12">
