...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Update emails for {{$persons_name['first_name']}}
                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <form method="post" action="{{action('Applicant\EmailController@store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="email_creare_hidden" value="{{$id}}"
                                id="email">
                    ...
                    <form method="post" action="{{action('Applicant\EmailController@update', $id) }}">
                        <div class="form-group">
                            ...
                            <div class="form-group col-lg-12 emails">
                                <div class="row">
                                    <input type="text" class="form-control email col-lg-10" name="email_list[]"
                                        value="{{$el['email']}}" id="email_list">
