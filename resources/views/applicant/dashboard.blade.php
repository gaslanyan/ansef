        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <p style="font-size:16px;color:#999;"><b>Here's a list of competitions that you can currently apply
                            for:</b></p>
                    <table class="table table-responsive-md table-sm table-bordered display" id="example"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-order="{{$comp['submission_end_date']}}"
                                    data-search="{{$comp['submission_end_date']}}">
                                    <b>{{$comp['submission_end_date']}}</b>
                                </td>
                                <td>
                                    <input type="reset" class="btn btn-primary" value="Learn more"
                                        onClick="open_container(1);">
                                </td>
                                <!-- Modal form-->
                                        ...
                                        <div class="modal-content" style="min-height:250px;min-width:320px;">
                                            <div class="modal-header">
                                                ...
                                                <button type="button" class="close" data-dismiss="modal"
                                                    style="width:50px;height:50px;">&times;</button>
                                            </div>
                    ...
                    <table class="table table-responsive-md table-sm table-bordered display" id="example"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-order="{{$comp['submission_start_date']}}"
                                    data-search="{{$comp['submission_start_date']}}">
