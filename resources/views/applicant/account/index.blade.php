                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <table class="table table-responsive-md table-sm table-bordered display" id="example"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td data-order="{{$applicant_person->first_name}}"
                                    data-search="{{$applicant_person->first_name}}" class="">
                                    {{$applicant_person->first_name}}
                                </td>
                                <td data-order="{{$applicant_person->last_name}}"
                                    data-search="{{$applicant_person->last_name}}" class="">
                                    {{$applicant_person->last_name}}
                                </td>
                                <td data-order="{{$applicant_person->type}}" data-search="{{$applicant_person->type}}"
                                    class="email_field">
                                ...
                                <td>
                                    ...
                                    @endif
                                    <br />
                                    <a href="{{action('Applicant\AddressController@create', $applicant_person->id)}}"
                                    ...
                                    <a href="{{action('Applicant\EmailController@create', $applicant_person->id)}}"
                                    ...
                                    <a href="{{action('Applicant\PhoneController@create', $applicant_person->id)}}"
                                        title="Show Phones" class="add_phone"><span
                                            class="fa fa-phone myButton personlist">Phone numbers</span>
                                    </a>
                                    <br />
                                    <a href="{{action('Applicant\InstitutionController@create', $applicant_person->id)}}"
                                        title="Show Institutions" class="add_institutions"><span
                                            class="fa fa-university myButton personlist">Employment</span>
                                    </a>
                                    @if($applicant_person->type =='participant')
                                    <a href="{{action('Applicant\DegreePersonController@create', $applicant_person->id)}}"
                                        title="Show Degrees" class="add_degrees"><span
                                            class="fa fa-graduation-cap myButton personlist">Education</span>
                                    </a><br />
                                    <a href="{{action('Applicant\BookController@create', $applicant_person->id)}}"
                                        title="Show Books" class="add_institutions"><span
                                            class="fa fa-book myButton personlist">Books</span>
                                    </a>
                                    <a href="{{action('Applicant\MeetingController@create', $applicant_person->id)}}"
                                        title="Show Meetings" class="add_meetings"><span
                                            class="fa fa-user-friends myButton personlist">Meetings</span>

                                    </a>
                                    <a href="{{action('Applicant\PublicationsController@create', $applicant_person->id)}}"
                                        title="Show Publications" class="add_publications"><span
                                            class="fas fa-sticky-note myButton personlist">Publications</span>
                                    </a>
                                    <a href="{{action('Applicant\HonorsController@create', $applicant_person->id)}}"
                                        title="Show Honors&Grants" class="add_honors"><span
                                            class="fa fa-trophy myButton personlist">Honors</span>
                                    </a>
                                    @endif
                                </td>
