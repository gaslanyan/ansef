                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <form method="post" action="{{action('Applicant\AddressController@store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="hidden_person_id" value="{{$id}}"
                                id="hidden_person_id">
                    ...
                    <form method="post" action="{{action('Applicant\AddressController@update', $id) }}">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <label>Street *:</label>
                                    <input type="text" class="form-control" name="street_list[]"
                                        value="{{$el['street']}}" id="street_list[]">
                                </div>
                                <div class="col-lg-5">
                                    <label>State/Municipality *:</label>
                                    <input type="text" class="form-control province" name="province_list[]"
                                        value="{{$el['province']}}" id="province_list[]">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-5">
                                    <label>City *:</label>
                                    <input type="text" class="form-control city" name="city_list[]"
                                        value="{{$el['city']}}" id="city_list[]">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label>Country *:</label>
                                    <select class="form-control" name="country_list[]" id="country_list[]">
                                        ...
                                        @foreach($country_list as $item)
                                        <option class="text-capitalize" value="{{$item['id']}}"
                                            {{$el['country_id'] == $item['id'] ? 'selected' : ''}}>
                                            {{$item['country_name']}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="col-lg-1">
                                    <a href="{{action('Applicant\AddressController@destroy', $el['id'])}}"
