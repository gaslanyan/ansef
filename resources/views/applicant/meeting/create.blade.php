                    ...
                    <form method="post" action="{{ action('Applicant\MeetingController@update', $id) }}">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-10">
                                ...
                                <label for="description">Meeting Description and location:</label>
                                <input type="text" class="form-control" name="meeting_description[]" id="description"
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" name="meeting_year[]"
                                    value="{{$meeting['year']}}" id="year">
                            </div>
                            <div class="form-group col-lg-4">
                                <label for="meeting_edit_ansefsupported_<?= $i;?>" class="label">Ansef
                                    Supported
                                    <input type="checkbox" class="" name="ansef_edit[{{$i}}]"
                                        id="meeting_edit_ansefsupported_<?= $i;?>"
                                        <?= ($meeting['ansef_supported'] == 1) ? 'checked' : '';?>>
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                <label for="meeting_edit_domestic<?= $i;?>" class="label">Domestic
                                    <input type="checkbox" class="" name="domestic[{{$i}}]"
