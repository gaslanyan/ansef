            ...
            <div class="card">
                ...
                <div class="card-body" style="overflow:auto;">
                    ...
                    <ul>
                        ...
                        <a href="{{action('Applicant\ProposalController@notifyrecommenders', $id)}}"
                            class="myButton">Click here</a> to send a reminder to the persons you have added to the
                        proposal as providers of receommendation letters of support but who have not yet submitted their
                        letters of support.
                    ...
                    <p>
                        No further action is needed on your part. You may however continue editing the proposal until
                        that date. If you make changes,
                        make sure you run this check again to assure the proposal is still complete.
                    </p>
                    <p>
                        The results of the competition will be announced by {{$competition->results_date}} on the ANSEF
                        website; and
