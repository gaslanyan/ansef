                    ...
                    <form method="post" action="{{action('Applicant\ProposalController@update', $proposal->id)}}"
                        ...
                        <div class="form-group col-lg-12" style="margin-top:20px">
                            ...
                            <input type="text" class="form-control" name="title" id="title" value="{{$proposal->title}}"
                                <?php if ($proposal->state == 'awarded' || $proposal->state == 'complete' || $proposal->state == 'unsuccessfull' || $proposal->state == 'disqualified') echo "disabled";?>>
                        </div>
                        <div class="form-group col-lg-12">
                            <label for="abstract">Abstract (<span id="abstractcharleft">250</span> words left):</label>
                            <textarea rows="4" class="form-control" name="abstract" id="abstract"">{{$proposal->abstract}}</textarea>
                            </div>
