        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body" style="overflow:auto;">
                    <br />
                    <p>Click <b>'Choose File'</b> and select a PDF document that describes your proposal. Then click
                    ...
                    <p>To read the instructions for preparing the proposal document, <a
                            href="{{action('Applicant\ProposalController@instructions', $id)}}">click here</a>.</p>
                    <br />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="uploadlater"><a
                                    href="{{action('Applicant\ProposalController@activeProposal', $id)}}"
                                    class="btn btn-primary">Upload later</a></div>
                        </div>
                    </div>
                </div>
            </div>
