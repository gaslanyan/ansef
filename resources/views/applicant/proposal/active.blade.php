                    ...
                    <table class="table table-responsive-md table-sm table-bordered display" id="example"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-order="{{$ap->competition->submission_end_date}}"
                                    data-search="{{$ap['state']}}">
                                ...
                                <td>
                                    ...
                                    <a href="{{action('Applicant\ProposalController@destroy', $ap['id'])}}"
                                        title="Delete"
                                        onclick="return confirm('Are you sure you want to delete the proposal?')"><span
                                            class="fa fa-trash myButton">Delete</span>
                                    </a><br />

                                    <a href="{{action('Applicant\ProposalController@updatepersons', $ap['id'])}}">
                                        <span class="fas fa-user-friends myButton">Add/Remove
                                            Participants</span></a><br />
                                    ...
                                    <a href="{{action('Applicant\ProposalController@check', $ap['id'])}}"><span
                                            class="fas fa-check-square myButton">Check</span></a>
