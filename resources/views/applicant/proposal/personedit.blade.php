                            ...
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    <select id="bcc" class="form-control person" name="theperson">
                                        ...
                                        <option class="text-capitalize" role="{{$item['type']}}"
                                            {{old('theperson')==$item['id'] ? 'selected' : ''}} value="{{$item['id']}}">
                                ...
                                <div class="form-group col-lg-4">
                                    <select id="sp" class="form-control participant" name="subtypeparticipant">
                                        ...
                                        <option class="text-capitalize" {{old('subtype')==$item ? 'selected' : ''}}
                                            value="{{$item}}">
                                            {{$item=="supportletter" ? "Recommendation letter" : ucfirst($item)}}
                                        </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group col-lg-12 emails">
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        <select id="person_list" class="form-control person" name="person_list[]">
                                            <option class="text-capitalize"
                                                role="{{$persons[$added_p['person_id']]['type']}}"
                                                value="{{$added_p['person_id']}}">
                                                {{$persons[$added_p['person_id']]['first_name'] . " ".$persons[$added_p['person_id']]['last_name']}}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <select id="role1" class="form-control participant" name="subtypeparticipant[]">
                                            ...
                                            <option class="text-capitalize" value="{{$item}}"
                                                <?php if($added_p['subtype']==$item) echo "selected"; ?>>
                                                {{$item=="supportletter" ? "Recommendation letter" : ucfirst($item)}}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <input type="hidden" class="form-control" name="person_list_hidden[]"
                                        value="{{$added_p['id']}}" id="person">
                                </div>
                            </div>
                            @endforeach
                        </div>
