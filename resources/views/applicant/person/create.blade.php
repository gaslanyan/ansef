                    ...
                    <form method="post" action="{{ action('Applicant\PersonController@store') }}" class="row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select id="type" class="form-control" name="type">
                                ...
                                <option class="text-capitalize" <?php if(old('type') == $val) echo 'selected'; ?>
                                    value="{{$item}}">{{$item}}</option>
                                @endif
                                @endforeach
                                @endif
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="row addresses">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input list="city" name="city[]" class="form-control" value="{{$selected}}"
                                        id="_city">
                                    <input type="hidden" name="city_id[]" value="{{$selected_id}}" id="city_id">
                                </div>
                                <div class="form-group col-lg-6">
