                    ...
                    <form method="post" action="{{ action('Applicant\PersonController@update', $id) }}" class="row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select id="state" class="form-control" name="state">
                                ...
                                <option class="text-capitalize" <?php if($person['state'] == $val) echo 'selected'; ?>
                                    value="{{$val}}">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <p><i class="fas fa-question-circle text-blue"></i></i><span
                                    style="color:#777;margin-left:10px;">The person
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" name="nationality" id="nationality">
                                ...
                                <option class="text-capitalize"
                                    <?php if($person['nationality'] == $item) echo 'selected'; ?> value="{{$item}}">
                                    {{$item}}</option>
                                @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select id="type" class="form-control" name="sex">
                                ...
                                @if(!empty($enum))
                                @foreach($enum as $val=>$item)
                                <option class="text-capitalize" <?php if($person['sex'] == $val) echo 'selected'; ?>
