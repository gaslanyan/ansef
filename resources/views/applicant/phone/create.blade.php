...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Update phone numbers for {{$persons_name['first_name']}}
                    {{$persons_name['last_name']}}
                        ...
                        <div class="col-lg-12 ">
                            <div class="row">
                                <div class="form-group col-lg-12 phones">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <input type="text" name="country_code" class="form-control col-lg-2"
                                                placeholder="Country code">

                                            <input type="text" class="form-control phone col-lg-8" name="phone"
                                                id="phone" placeholder="Number">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-lg-12">
                                    <input type="hidden" class="form-control" name="phone_create_hidden" value="{{$id}}"
                                        id="email">
                        ...
                        <div class="col-lg-12 ">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-12 phones">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <input type="text" class="form-control col-lg-2" name="country_code[]"
                                                value="{{$phl['country_code']}}" id="code">
                                            <input type="text" class="form-control phone col-lg-8" name="phone_list[]"
                                                value="{{$phl['number']}}" id="phone">
                                            <a href="{{action('Applicant\PhoneController@destroy', $phl['id'])}}"
                                                class="btn-link col-lg-2">
                                                <i class="fa fa-trash"></i>
                                            </a>
                                            <input type="hidden" class="form-control" name="phone_list_hidden[]"
                                                value="{{$phl['id']}}" id="email">
                                        </div>
                                    </div>
                                </div>
                                @endforeach
