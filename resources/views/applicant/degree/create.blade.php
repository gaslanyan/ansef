        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body" style="overflow:auto;">
                            ...
                            <div class="row">
                                <div class="form-group col-8">
                                    ...
                                    <select class="form-control" name="description" id="description">
                                        ...
                                        <option <?php if(old('description') == $dl->text) echo 'selected'; ?>
                                            value="{{$dl->id}}">{{$dl->text}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <select id="inst" class="form-control" name="institution_id">
                                        ...
                                        <option class="text-capitalize" value="{{$val}}"
                                            <?php $val == old('institution_id') ? 'selected' : '' ?>>{{$item}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    <input type="text" id="insttext" class="form-control" name="institution"
                    ...
                    <form method="post" action="{{ action('Applicant\DegreePersonController@update', $id) }}"
                        class="row">
                        @csrf
                        ...
                        <div class="row col-12">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <select class="form-control" name="description[]" id="description">
                                    <option value="0">Select Degree</option>
                                    @foreach($degrees_list as $dl)
                                    <option <?php if($degree->degree_id == $dl->id) echo 'selected'; ?>
                                        value="{{$dl->id}}">{{$dl->text}}</option>
                                    @endforeach
                                </select>
                                <input type="hidden" class="form-check-inline" name="degrees_add_hidden_id[]"
                            ...
                            <div class="col-lg-4">
                                ...
                                <select id="inst" class="form-control" name="institution_id[]">
                                    ...
                                    @foreach($institutions as $val=>$item)
                                    <option class="text-capitalize" value="{{$val}}"
                                        {{$val == $degree->institution_id ? 'selected' : ''}}>{{$item}}</option>
                                    @endforeach
                                    @endif
                                </select>
