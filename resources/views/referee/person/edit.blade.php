                    ...
                    <form method="post" action="{{ action('Referee\PersonController@update', $id) }}" class="row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" name="nationality" id="nationality">
                                ...
                                <option class="text-capitalize" value="{{$item->country_name}}" selected>
                                    {{$item->country_name}}</option>
                                @else
                                <option class="text-capitalize" value="{{$item->country_name}}">{{$item->country_name}}
                                </option>
                                @endif
                                @endforeach
                                @endif
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <select id="type" class="form-control" name="sex">
                                ...
                                <option class="text-capitalize" @if ($item==$person['sex']) {{'selected'}}@endif
                            ...
                            <div class="row addresses">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select id="country_id" class="addr form-control" name="country_id">
                                        ...
                                        <option class="text-capitalize" value="{{$item->id}}" selected>
                                            {{$item->country_name}}</option>
                                        @else
                                        <option class="text-capitalize" value="{{$item->id}}">{{$item->country_name}}
                                        </option>
                                        @endif
                                        @endforeach
                                        @endif
